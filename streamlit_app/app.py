...
OPCIONES_DISPOSITIVO = [
    "Catéter venoso central", "Sonda vesical", "Ventilación mecánica",
    "Catéter epicutáneo", "Catéter de hemodiálisis", "Catéter umbilical",
    "Derivativa ventricular externa", "Derivativa ventricular peritoneal", "Otro",
]
...
if modo == "🔍 Individual":
    ...
    with st.form("form_individual"):
        ...
        with c3:
            ...
            tipo_invasivo = st.selectbox("Tipo de invasivo", OPCIONES_DISPOSITIVO)
