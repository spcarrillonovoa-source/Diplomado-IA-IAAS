...
- **Modo Individual**: completa el formulario y pulsa "Predecir y guardar".
  El resultado se muestra en pantalla y el caso (datos + predicción) se
  agrega como nueva fila en `data/casos_ingresados.xlsx` dentro del repo,
  mediante un commit automático.
